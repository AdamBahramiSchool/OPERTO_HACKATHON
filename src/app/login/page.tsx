  ...
  return (
    <div className="min-h-screen bg-[#030712] text-white flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        />
        <div className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full bg-indigo-600/20 blur-[100px] animate-pulse-orb" />
        <div className="absolute -bottom-32 -right-32 w-[400px] h-[400px] rounded-full bg-purple-600/15 blur-[80px] animate-pulse-orb" style={{ animationDelay: "3s" }} />
      </div>
